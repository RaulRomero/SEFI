...
Cabe mencionar que HSBCBOLBFV.MX y VALUEV5B.MX fueron solo una vez parte de los 3 mejores en las características anteriores.
...
\begin{enumerate}
\item Por cada unidad de riesgo, el fondo VALUEV5B.MX pierde $16.20261$ por ciento de rendimiento.
\item Por cada unidad de riesgo, el fondo GBMMODBO.MX pierde $20.78047$ por ciento de rendimiento.
\item Por cada unidad de riesgo, el fondo HSBCBOLBFV.MX pierde $17.28876$ por ciento de rendimiento.
\item Por cada unidad de riesgo, el fondo ACTI500B3.MX pierde $17.37589$ por ciento de rendimiento.
\item Por cada unidad de riesgo, el fondo FRANOPRB1.MX pierde $13.39259$ por ciento de rendimiento.
\end{enumerate
}
...
m2 <- m2*100
@
Retorno del Portafolio: 0.022888 por ciento.Conclusiones del método: 
\begin{enumerate}
\item El fondo VALUEV5B.MX tiene $26.584754$ por ciento de retorno ajustado.
Bajo las mismas condiciones del mercado, el retorno ajustado es mayor al retorno del portafolio.

\item El fondo GBMMODBO.MX tiene $49.957131$ por ciento de retorno ajustado negativo.
Bajo las mismas condiciones del mercado, el retorno ajustado es menor al retorno del portafolio.

\item El fondo HSBCBOLBFV.MX tiene $10.452223$ por ciento de retorno ajustado.
Bajo las mismas condiciones del mercado, el retorno ajustado es mayor al retorno del portafolio.

\item El fondo ACTI500B3.MX tiene $3.705079$ por ciento de retorno ajustado.
Bajo las mismas condiciones del mercado, el retorno ajustado es mayor al retorno del portafolio.

\item El fondo FRANOPRB1.MX tiene $69.154464$ por ciento de retorno ajustado.
Bajo las mismas condiciones del mercado, el retorno ajustado es mayor al retorno del portafolio.
\end{enumerate}
...
DR <- DR*100
@
Retorno del Portafolio: 0.00. Conclusiones del método:
\begin{enumerate}
\item El fondo VALUEV5B.MX tiene $0.313307$ por ciento de retorno diferencial.
Bajo las mismas condiciones del mercado, el retorno diferencial es mayor al retorno del portafolio.

\item El fondo GBMMODBO.MX tiene $0.40653$ por ciento de retorno diferencial negativo.
Bajo las mismas condiciones del mercado, el retorno diferencial es menor al retorno del portafolio.

\item El fondo HSBCBOLBFV.MX tiene $0.108537$ por ciento de retorno diferencial.
Bajo las mismas condiciones del mercado, el retorno diferencial es mayor al retorno del portafolio.

\item El fondo ACTI500B3.MX tiene $0.091393$ por ciento de retorno diferencial.
Bajo las mismas condiciones del mercado, el retorno diferencial es mayor al retorno del portafolio.

\item El fondo FRANOPRB1.MX tiene $0.985499$ por ciento de retorno diferencial.
Bajo las mismas condiciones del mercado, el retorno diferencial es mayor al retorno del portafolio.
\end{enumerate}
...
total_retorno <- prop_bench2[1:(length (prop_bench2)-1)] * rendimientos[,1:(ncol(rendimientos)-1)]  
aux <-  matrix(prop_cete2*libre_riesgo_anual, nrow = nrow(total_retorno), ncol = (length(prop_cete2)))
